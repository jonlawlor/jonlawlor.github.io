...
Egon Elbre helped review and provided a revised version of the unordered distinct operation.  He also gave an implementation using the unsafe package, which was too advanced for this post.
